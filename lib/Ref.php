...
class Ref
{
    ...
    static function student_info($numStudent,$fNameStudent)
	{
		$fNameStudent = urlencode(trim(strip_tags($fNameStudent)));
		$numStudent = urlencode(mb_strtolower(trim(strip_tags($numStudent))));
		// var_dump("http://lk.chuvsu.ru/export/student_info.php?zachetka={$numStudent}&fam={$fNameStudent}");
		// die();
		$student =  file_get_contents("http://lk.chuvsu.ru/export/student_info.php?zachetka={$numStudent}&fam={$fNameStudent}");
		 //var_dump("http://lk.chuvsu.ru/export/student_info.php?zachetka={$numStudent}&fam={$fNameStudent}");
		$xml = simplexml_load_string($student, "SimpleXMLElement", LIBXML_NOCDATA);
