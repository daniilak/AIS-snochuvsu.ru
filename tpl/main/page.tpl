...
<body>
	...
	<section class="text-center">
        <div class="container">
          <div class="image">
        	<img src="/view2.gif" alt="Автоматизированная Информационная Система АИС СНО «Основа»">
          </div>
          <h1 class="jumbotron-heading">АИС СНО «Основа»</h1>
          <p class="lead text-muted">Платформа для работы с мероприятиями Студенческого Научного Общества ЧувГУ</p>
          <p>Получите доступ и начните работать с системой!</p>
		  <p>{error}{msg}</p>
          <p>
            <a href="{auth_url}" class="btn btn-primary my-3">Войти через ВКонтакте</a>
            <a href="/program" class="btn btn-secondary my-3">Календарь мероприятий</a>
            <a href="/print" class="btn btn-secondary my-3">Статистика мероприятий</a>
          </p>
        </div>
      </section>
	</main>
